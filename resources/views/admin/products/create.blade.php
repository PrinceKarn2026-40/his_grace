...
<style>
    ...
    .form-control, .form-select {
        border: 1px solid #e5e5e5; border-radius: 10px; padding: .65rem .9rem;
    ...
    .btn-save {
        ...
        color: #fff; border: none; border-radius: 10px; padding: .8rem 2.5rem;
        font-weight: 700; font-size: .95rem; letter-spacing: .03em;
        transition: .2s; display: inline-flex; align-items: center; gap: .5rem;
    }
    .btn-save:hover { background: linear-gradient(135deg, var(--red-dark,#96281b) 0%, var(--red) 100%); color: #fff; transform: translateY(-1px); box-shadow: 0 8px 24px rgba(192,57,43,.35); }
...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        ...
        <p class="text-muted small mb-0">Fill in the details below and save</p>
    </div>
</div>
            ...
            <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius:16px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                        value="{{ old('name') }}" placeholder="e.g. Classic White Shirt" required>
                    @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-control" rows="4" placeholder="Describe the product...">{{ old('description') }}</textarea>
                </div>
                <div class="row g-3">
                    <div class="col-md-6">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="sale_price" step="0.01" min="0"
                            class="form-control" value="{{ old('sale_price') }}" placeholder="Optional">
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="toggle-card">
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1"
                                    {{ old('featured') ? 'checked' : '' }} style="width:2.5rem;height:1.3rem;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="toggle-card">
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="is_new" id="is_new" value="1"
                                    {{ old('is_new') ? 'checked' : '' }} style="width:2.5rem;height:1.3rem;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius:16px;">
                ...
                <div id="imgPlaceholder" class="img-placeholder" onclick="document.getElementById('imageInput').click()">
                    ...
                    <span class="mt-2 small fw-semibold">Click to upload</span>
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary mt-2 w-100 d-none" id="removeImg"
                    onclick="removeImage()">
